...
from llm_service_gigachat import GigaChatLLMService
...
class TextBotGigaChat:
    def __init__(self):
        self.llm_service = GigaChatLLMService()
...
💡 **Используется: GigaChat (бесплатно!)**
...
def main():
    ...
    # Запускаем бота
    logger.info("Бот с GigaChat запущен...")
